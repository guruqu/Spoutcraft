...
public class NetServerHandler extends NetHandler {
	...
	public NetServerHandler(MinecraftServer par1MinecraftServer,
			...
			this.mcServer.getConfigurationManager().sendChatMsg(
					ChatMessageComponent
							.createFromTranslationWithSubstitutions(
									...
									new Object[] { this.playerEntity
											.getTranslatedEntityName() })
							.setColor(EnumChatFormatting.YELLOW));
			this.mcServer.getConfigurationManager().playerLoggedOut(
					this.playerEntity);
	...
	public void func_110774_a(Packet27PlayerInput par1Packet27PlayerInput) {
		this.playerEntity.setEntityActionState(
				par1Packet27PlayerInput.func_111010_d(),
				par1Packet27PlayerInput.func_111012_f(),
				par1Packet27PlayerInput.func_111013_g(),
				par1Packet27PlayerInput.func_111011_h());
	}

	public void handleFlying(Packet10Flying par1Packet10Flying) {
		WorldServer var2 = this.mcServer
		...
		if (!this.playerEntity.playerConqueredTheEnd) {
			...
			if (!this.hasMoved) {
				...
				if (par1Packet10Flying.xPosition == this.lastPosX
						&& var3 * var3 < 0.01D
			...
			if (this.hasMoved) {
				...
				if (this.playerEntity.isPlayerSleeping()) {
					this.playerEntity.onUpdateEntity();
					this.playerEntity.setPositionAndRotation(this.lastPosX,
							this.lastPosY, this.lastPosZ,
				...
				if (par1Packet10Flying.moving) {
					...
					if (!this.playerEntity.isPlayerSleeping()
						...
						this.mcServer.getLogAgent().logWarning(
				...
				this.playerEntity.ySize = 0.0F;
				this.playerEntity.setPositionAndRotation(this.lastPosX,
						this.lastPosY, this.lastPosZ, var11, var12);
				...
				double var21 = Math.min(Math.abs(var15),
						Math.abs(this.playerEntity.motionY));
				double var23 = Math.min(Math.abs(var17),
						Math.abs(this.playerEntity.motionZ));
				double var25 = var19 * var19 + var21 * var21 + var23 * var23;

				if (var25 > 100.0D
						&& (!this.mcServer.isSinglePlayer() || !this.mcServer
					...
					this.mcServer.getLogAgent().logWarning(
							this.playerEntity.getCommandSenderName()
									...
									+ var15 + "," + var17 + " (" + var19 + ", "
									+ var21 + ", " + var23 + ")");
					this.setPlayerLocation(this.lastPosX, this.lastPosY,
							this.lastPosZ, this.playerEntity.rotationYaw,
							this.playerEntity.rotationPitch);
					return;
				}
				...
				boolean var28 = var2
						.getCollidingBoundingBoxes(
								...
								this.playerEntity.boundingBox.copy().contract(
										(double) var27, (double) var27,
										(double) var27)).isEmpty();

				if (this.playerEntity.onGround && !par1Packet10Flying.onGround
						&& var15 > 0.0D) {
				...
				if (!this.mcServer.isFlightAllowed()
						&& !this.playerEntity.theItemInWorldManager
								.isCreative()
				...
				this.mcServer.getConfigurationManager()
						.serverUpdateMountedMovingPlayer(this.playerEntity);
				this.playerEntity.updateFlyingState(this.playerEntity.posY
						- var3, par1Packet10Flying.onGround);
	 ...
	 */
	public void setPlayerLocation(double par1, double par3, double par5,
	...
	public void handleBlockDig(Packet14BlockDig par1Packet14BlockDig) {
		...
		if (par1Packet14BlockDig.status == 4) {
			...
			if (par1Packet14BlockDig.status == 0) {
				if (!this.mcServer.isBlockProtected(var2, var4, var5, var6,
						this.playerEntity)) {
					this.playerEntity.theItemInWorldManager.onBlockClicked(
							var4, var5, var6, par1Packet14BlockDig.face);
				} else {
					this.playerEntity.playerNetServerHandler
				...
				this.playerEntity.theItemInWorldManager
						.uncheckedTryHarvestBlock(var4, var5, var6);
	...
	public void handlePlace(Packet15Place par1Packet15Place) {
		...
		if (par1Packet15Place.getDirection() == 255) {
			...
			this.playerEntity.theItemInWorldManager.tryUseItem(
					this.playerEntity, var2, var3);
		} else if (par1Packet15Place.getYPosition() >= this.mcServer
				.getBuildLimit() - 1
				&& (par1Packet15Place.getDirection() == 1 || par1Packet15Place
						.getYPosition() >= this.mcServer.getBuildLimit())) {
			this.playerEntity.playerNetServerHandler
					.sendPacketToPlayer(new Packet3Chat(ChatMessageComponent
							.createFromTranslationWithSubstitutions(
									"build.tooHigh",
									new Object[] { Integer
											.valueOf(this.mcServer
													.getBuildLimit()) })
							.setColor(EnumChatFormatting.RED)));
			var4 = true;
		} else {
			if (this.hasMoved
					&& this.playerEntity.getDistanceSq((double) var5 + 0.5D,
							(double) var6 + 0.5D, (double) var7 + 0.5D) < 64.0D
					&& !this.mcServer.isBlockProtected(var2, var5, var6, var7,
							this.playerEntity)) {
				this.playerEntity.theItemInWorldManager.activateBlockOrUseItem(
						this.playerEntity, var2, var3, var5, var6, var7, var8,
		...
		if (var3 == null || var3.getMaxItemUseDuration() == 0) {
			...
			Slot var9 = this.playerEntity.openContainer.getSlotFromInventory(
			...
			if (!ItemStack.areItemStacksEqual(
				...
				this.sendPacketToPlayer(new Packet103SetSlot(
						this.playerEntity.openContainer.windowId,
						var9.slotNumber, this.playerEntity.inventory
								.getCurrentItem()));
			}
		}
	}
	...
	public void handleErrorMessage(String par1Str, Object[] par2ArrayOfObj) {
		this.mcServer.getLogAgent().logInfo(
				this.playerEntity.getCommandSenderName() + " lost connection: "
						+ par1Str);
		this.mcServer.getConfigurationManager().sendChatMsg(
				ChatMessageComponent.createFromTranslationWithSubstitutions(
						"multiplayer.player.left",
						new Object[] { this.playerEntity
								.getTranslatedEntityName() }).setColor(
		...
		if (this.mcServer.isSinglePlayer()
				&& this.playerEntity.getCommandSenderName().equals(
						this.mcServer.getServerOwner())) {
			this.mcServer.getLogAgent().logInfo(
	...
	public void sendPacketToPlayer(Packet par1Packet) {
		...
		try {
			...
			CrashReport var6 = CrashReport.makeCrashReport(var5,
					"Sending packet");
	...
	public void handleChat(Packet3Chat par1Packet3Chat) {
		if (this.playerEntity.getChatVisibility() == 2) {
			this.sendPacketToPlayer(new Packet3Chat(ChatMessageComponent
					.createFromTranslationKey("chat.cannotSend").setColor(
			...
			if (var2.length() > 100) {
				...
				var2 = org.apache.commons.lang3.StringUtils
						.normalizeSpace(var2);
				...
				if (var2.startsWith("/")) {
					...
					if (this.playerEntity.getChatVisibility() == 1) {
						this.sendPacketToPlayer(new Packet3Chat(
								ChatMessageComponent.createFromTranslationKey(
										"chat.cannotSend").setColor(
										EnumChatFormatting.RED)));
						return;
					}

					ChatMessageComponent var4 = ChatMessageComponent
							.createFromTranslationWithSubstitutions(
									"chat.type.text",
									new Object[] {
											this.playerEntity
													.getTranslatedEntityName(),
											var2 });
					this.mcServer.getConfigurationManager().func_110459_a(var4,
							false);
				}
	...
	private void handleSlashCommand(String par1Str) {
		this.mcServer.getCommandManager().executeCommand(this.playerEntity,
				par1Str);
	}
	...
	public void handleEntityAction(Packet19EntityAction par1Packet19EntityAction) {
		...
		if (par1Packet19EntityAction.action == 1) {
			...
			if (this.playerEntity.ridingEntity != null
				...
				((EntityHorse) this.playerEntity.ridingEntity)
						.setJumpPower(par1Packet19EntityAction.auxData);
			}
		} else if (par1Packet19EntityAction.action == 7
				&& this.playerEntity.ridingEntity != null
				&& this.playerEntity.ridingEntity instanceof EntityHorse) {
			((EntityHorse) this.playerEntity.ridingEntity)
					.openGUI(this.playerEntity);
		}
	}
			...
			if (this.playerEntity.getDistanceSqToEntity(var3) < var5) {
				if (par1Packet7UseEntity.isLeftClick == 0) {
					...
					if (var3 instanceof EntityItem
						...
						this.mcServer.logWarning("Player "
								+ this.playerEntity.getCommandSenderName()
	...
	public void handleClientCommand(
			Packet205ClientCommand par1Packet205ClientCommand) {
		this.playerEntity.func_143004_u();

		if (par1Packet205ClientCommand.forceRespawn == 1) {
			if (this.playerEntity.playerConqueredTheEnd) {
				this.playerEntity = this.mcServer.getConfigurationManager()
						.respawnPlayer(this.playerEntity, 0, true);
			} else if (this.playerEntity.getServerForPlayer().getWorldInfo()
				...
				if (this.mcServer.isSinglePlayer()
					...
					BanEntry var2 = new BanEntry(
							this.playerEntity.getCommandSenderName());
					var2.setBanReason("Death in Hardcore");
					this.mcServer.getConfigurationManager().getBannedPlayers()
							.put(var2);
					this.playerEntity.playerNetServerHandler
							.kickPlayerFromServer("You have died. Game over, man, it\'s game over!");
				}
				...
				this.playerEntity = this.mcServer.getConfigurationManager()
						.respawnPlayer(this.playerEntity, 0, false);
			}
		}
	}
	...
	public void handleWindowClick(Packet102WindowClick par1Packet102WindowClick) {
		...
		if (this.playerEntity.openContainer.windowId == par1Packet102WindowClick.window_Id
				&& this.playerEntity.openContainer
						.isPlayerNotUsingContainer(this.playerEntity)) {
			ItemStack var2 = this.playerEntity.openContainer.slotClick(
					par1Packet102WindowClick.inventorySlot,
					par1Packet102WindowClick.mouseClick,
					par1Packet102WindowClick.holdingShift, this.playerEntity);
			...
			if (ItemStack.areItemStacksEqual(
				...
				this.playerEntity.openContainer.setPlayerIsPresent(
						this.playerEntity, false);
				ArrayList var3 = new ArrayList();

				for (int var4 = 0; var4 < this.playerEntity.openContainer.inventorySlots
						.size(); ++var4) {
					var3.add(((Slot) this.playerEntity.openContainer.inventorySlots
							.get(var4)).getStack());
				}

				this.playerEntity.sendContainerAndContentsToPlayer(
						this.playerEntity.openContainer, var3);
			}
		}
	}
	...
	public void handleEnchantItem(Packet108EnchantItem par1Packet108EnchantItem) {
		...
		if (this.playerEntity.openContainer.windowId == par1Packet108EnchantItem.windowId
				&& this.playerEntity.openContainer
						.isPlayerNotUsingContainer(this.playerEntity)) {
			this.playerEntity.openContainer.enchantItem(this.playerEntity,
		...
		if (this.playerEntity.theItemInWorldManager.isCreative()) {
			...
			boolean var4 = par1Packet107CreativeSetSlot.slot >= 1
					&& par1Packet107CreativeSetSlot.slot < 36 + InventoryPlayer
							.getHotbarSize();
			boolean var5 = var3 == null || var3.itemID < Item.itemsList.length
					&& var3.itemID >= 0 && Item.itemsList[var3.itemID] != null;
			boolean var6 = var3 == null || var3.getItemDamage() >= 0
					&& var3.getItemDamage() >= 0 && var3.stackSize <= 64
					&& var3.stackSize > 0;

			if (var4 && var5 && var6) {
				if (var3 == null) {
					this.playerEntity.inventoryContainer
				...
				this.playerEntity.inventoryContainer.setPlayerIsPresent(
					...
					&& this.creativeItemCreationSpamThresholdTally < 200) {
	...
	public void handleTransaction(Packet106Transaction par1Packet106Transaction) {
		Short var2 = (Short) this.field_72586_s
				.lookup(this.playerEntity.openContainer.windowId);
	...
	public void handleUpdateSign(Packet130UpdateSign par1Packet130UpdateSign) {
		...
		if (var2.blockExists(par1Packet130UpdateSign.xPosition,
			...
			TileEntity var3 = var2.getBlockTileEntity(
			...
			if (var3 instanceof TileEntitySign) {
				...
				if (!var4.isEditable()
						|| var4.func_142009_b() != this.playerEntity) {
					this.mcServer.logWarning("Player "
							+ this.playerEntity.getCommandSenderName()
			...
			for (var5 = 0; var5 < 4; ++var5) {
				...
				if (par1Packet130UpdateSign.signLines[var5].length() > 15) {
					...
					for (var8 = 0; var8 < par1Packet130UpdateSign.signLines[var5]
							.length(); ++var8) {
						if (!ChatAllowedCharacters
								.isAllowedCharacter(par1Packet130UpdateSign.signLines[var5]
										.charAt(var8))) {
							var6 = false;
						}
					}
	...
	public void handlePlayerAbilities(
		...
		this.playerEntity.capabilities.isFlying = par1Packet202PlayerAbilities
				.getFlying() && this.playerEntity.capabilities.allowFlying;
	}

	public void handleAutoComplete(
			Packet203AutoComplete par1Packet203AutoComplete) {
		StringBuilder var2 = new StringBuilder();
		String var3;

		for (Iterator var4 = this.mcServer.getPossibleCompletions(
				this.playerEntity, par1Packet203AutoComplete.getText())
				.iterator(); var4.hasNext(); var2.append(var3)) {
	...
	public void handleCustomPayload(
			Packet250CustomPayload par1Packet250CustomPayload) {
					...
					if (!this.mcServer.isCommandBlockEnabled()) {
						this.playerEntity
								.sendChatToPlayer(ChatMessageComponent
										.createFromTranslationKey("advMode.notEnabled"));
						...
						try {
							...
							TileEntity var9 = this.playerEntity.worldObj
									.getBlockTileEntity(var5, var15, var7);

							if (var9 != null
									&& var9 instanceof TileEntityCommandBlock) {
								((TileEntityCommandBlock) var9)
										.setCommand(var8);
								this.playerEntity.worldObj.markBlockForUpdate(
										var5, var15, var7);
								this.playerEntity
										.sendChatToPlayer(ChatMessageComponent
												.createFromTranslationWithSubstitutions(
						...
						this.playerEntity
								.sendChatToPlayer(ChatMessageComponent
										.createFromTranslationKey("advMode.notAllowed"));
					}
				} else if ("MC|Beacon"
